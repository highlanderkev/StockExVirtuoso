...
/**
 * This class will handle displaying all the market data for the user.
 *
 * @author hieldc
...
public class MarketDisplay extends javax.swing.JFrame {
    ...
    void updateMarketData(String product, Price bp, int bv, Price sp, int sv) throws Exception {
    ...
    void updateLastSale(String product, Price p, int v) throws Exception {
