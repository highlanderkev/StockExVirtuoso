...
/**
 * This class displays quote entries for the market display.
 *
 * @author hieldc
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
            if (buyPriceText.getText().trim().isEmpty()) {
                throw new GUIDataException("Buy price cannot be empty");
            }
            if (sellPriceText.getText().trim().isEmpty()) {
                throw new GUIDataException("Sell price cannot be empty");
            }
            ...
            if (sellVolumeText.getText().trim().isEmpty()) {
                throw new GUIDataException("Sell Volume cannot be empty");
            }
